...
function calcPI(iterations){
    // const piVal = 3.14159;
    let pi = 0, divisor = 1;
    // Javascript only has precision up to 16 digits
...
// If they did supply new data we can create the custom MadLib
    } else {
    createMLSentence();
    }
}
...
// Get all the values the user entered by incrementing from 0 to 13 to match the given ids 
    for(i = 0; i <= 13; i++){
...
// every place there is a ~ put in the user supplied values
